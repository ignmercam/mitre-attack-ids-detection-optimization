...
DIR_ATAQUES="/mnt/hgfs/Ataques"
DIR_CIC2018="/mnt/hgfs/CIC2018"
LOGS_BASE="./logs_analisis_completo"
DIR_TEMP="./tmp_snort_running"

# Mapeo de los 6 casos de estudio
ALL_CONFS=(
    "/etc/snort/snort_Community.conf"
    "/etc/snort/snort_CommunityCD.conf"
...
echo "======================================================"
echo "      ANALIZADOR MAESTRO INTERACTIVO (6 CASOS TFG)    "
echo "======================================================"

# --- SELECCIÓN DE PAQUETE DE REGLAS ---
echo -e "\n[?] ¿Qué paquetes de reglas desea procesar?"
echo "1) Solo Community"
echo "2) Solo Community (CD)"
echo "3) Solo Registered (Standard)"
echo "4) Solo Registered (CD)"
echo "5) Solo ETOpen"
echo "6) Solo ETOpen (CD)"
echo "7) TODOS LOS PAQUETES (BARRIDO TOTAL)"
read -p "Seleccione una opción [1-7]: " opt_pkg
...
for idx in "${PKG_INDEXES[@]}"; do
    ...
    for FUENTE in "${FUENTES[@]}"; do
        PCAP_PATH="$([ "$FUENTE" == "Ataques" ] && echo "$DIR_ATAQUES" || echo "$DIR_CIC2018")"
